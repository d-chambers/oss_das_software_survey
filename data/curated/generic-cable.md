...
status: included
decision_reason: Reusable DAS-specific modeling code published with no license file, which grants no reuse
  rights and is recorded as unlicensed rather than excluded.
...
sources:
- github.com/subsurface4d/genericcable
