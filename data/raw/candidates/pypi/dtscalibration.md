---
key: pypi/dtscalibration
source: pypi
name: dtscalibration
package: dtscalibration
description: Load Distributed Temperature Sensing (DTS) files, calibrate the temperature and estimate
  its uncertainty.
registry_url: https://pypi.org/project/dtscalibration/
version: 3.1.0
