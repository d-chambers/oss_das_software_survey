...
status: included
decision_reason: Reusable DAS phase-picking and detection models under a custom academic/commercial license,
  which is source-available rather than OSI-approved.
