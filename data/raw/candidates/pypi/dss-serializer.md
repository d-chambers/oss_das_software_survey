---
key: pypi/dss-serializer
source: pypi
name: dss-serializer
package: dss-serializer
description: Django Simple Serializer is a serializer to help user serialize django data or python list
  into json,xml,dict data in a simple way.
registry_url: https://pypi.org/project/dss-serializer/
version: '1.1'
last_release: '2019-02-27'
repository_url: https://github.com/hengdai/django-simple-serializer
