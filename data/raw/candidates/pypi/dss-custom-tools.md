---
key: pypi/dss-custom-tools
source: pypi
name: dss-custom-tools
package: dss-custom-tools
description: Some custom tools for working with the DSS
registry_url: https://pypi.org/project/dss-custom-tools/
version: 0.1.0
last_release: '2026-07-31'
repository_url: null
repository_declared_in_metadata: false
license_stated: "Apache License\n                                   Version 2.0, January 2004\n      \
  ...
  \ Work to which such Contribution(s) was submitted. If You\n              institute patent litigation\
  ...
  \ a fee for, acceptance of support, warranty, indemnity,\n              or other liability obligations\
