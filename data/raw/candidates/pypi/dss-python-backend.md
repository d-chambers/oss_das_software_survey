---
key: pypi/dss-python-backend
source: pypi
name: dss-python-backend
package: dss-python-backend
description: Low-level Python bindings and native libs for DSS-Python. Not intended for direct usage,
  see DSS-Python instead.
registry_url: https://pypi.org/project/dss-python-backend/
version: 0.14.5
last_release: '2026-02-26'
repository_url: https://github.com/dss-extensions/dss_python_backend
