...
status: included
decision_reason: Reusable DAS metadata tooling. The detected CC BY license is a content license that does
  not clearly establish reuse terms for the code, so the class is unknown rather than open.
...
sources:
- github.com/das-rcn/das_metadata
...
provenance:
  ...
  - claude-sonnet-5
  ran_at: '2026-08-20T08:08:25+00:00'
