...
status: watchlist
decision_reason: MIT licensed and DAS-specific, but the repository holds four demonstration scripts with
  no packaging, tests, or documented interface, so its reusability is unresolved.
...
sources:
- github.com/xinxin-he/opendas-stream
