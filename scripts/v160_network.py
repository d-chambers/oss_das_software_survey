#!/usr/bin/env python3
"""Render which catalogued DAS projects are built on other DAS projects.
...
from oss_das.figures.data import network_from_records
...
def main() -> int:
    ...
    written = write_figure(
        NAME,
        plates.network_plate(network_from_records()),
        resolve_out(args),
        pdf=args.pdf,
        png=args.png,
