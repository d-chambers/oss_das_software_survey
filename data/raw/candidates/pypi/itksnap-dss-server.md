---
key: pypi/itksnap-dss-server
source: pypi
name: itksnap-dss-server
package: itksnap-dss-server
description: ITK-SNAP Distributed Segmentation Service (DSS) middleware server
registry_url: https://pypi.org/project/itksnap-dss-server/
version: 0.1.0
last_release: '2026-08-25'
repository_url: https://github.com/pyushkevich/alfabis_server
